...
def bended_plate_2d(workplane, way_points, plate_t, fillet=None):
    '''
    ...
    side_points = make_both_side_points(way_points[0], line_dir, plate_t)
    ...
    for i in range(len(lines) - 1):
        ...
        t = plate_t / math.cos(l0_dir - avg_dir)
    ...
    side_points = make_both_side_points(way_points[-1], line_dir, plate_t)
    side1_points.append(side_points[0])
    side2_points.append(side_points[1])
